...
<div class="row col-lg-offset-2 col-lg-8">
    ...
    <div id="galerie-concours" class="carousel slide col-lg-12">
        ...
        foreach($galController->getAllImages() as $imageUrl){

        /*$object = $ImageManager->getObject($imageUrl);
            echo '<br> TEST<br>';
            var_dump($object);*/
            ...
            <div class="col-lg-4 col-md-4 col-xs-6 thumb" data-groups='["wall"]'>
                <div class="thumbnail">
                    <div class="caption">
                        ...
                        <div class="fb-like" data-href="<?php echo $imageUrl['id_photo']; ?>" data-layout="standard" data-action="like" data-show-faces="false" data-share="true"></div>
                    ...
                    <img class="lazy img-responsive" data-original="<?php echo $imageUrl['url'] ?>" src="<?php echo $imageUrl ?>" alt="">
                </div>
            </div>
        <?php
        }
